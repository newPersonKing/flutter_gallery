...
class _ContactCategory extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: const EdgeInsets.symmetric(vertical: 16.0),/*top bottom各16个像素的空格  水平没有*/
      ...
      child: Scaffold(
        ...
        body: CustomScrollView(
          slivers: <Widget>[
            ...
            SliverList(
              delegate: SliverChildListDelegate(<Widget>[/*委托 生成widget 这里加载方式是懒加载 避免一次性加载太多的widget*/
